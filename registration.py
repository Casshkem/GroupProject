...
def login(id, s_list):
    ...
    # Check if the ID and PIN combination is in s_list
    for student in s_list:
        if id == student[0] and pin == student[1]:
            print("Verification successful.")
            return True

    # If the combination is not in s_list, display error message and return False
    print("Error: Incorrect ID or PIN.")
    return False
    # ------------------------------------------------------------
